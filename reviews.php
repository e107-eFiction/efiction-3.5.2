...
if($action == "delete") {
	...
	if(isset($_POST['submit'])) {
		...
		$rating = isNumber($_POST['rating']) ? $_POST['rating'] : -1;
	...
	{
		$adminlink = "";
		if(isADMIN) $adminlink = "<span class='label'>"._ADMINOPTIONS.": </span> [<a href=\"reviews.php?action=edit&amp;reviewid=".$reviews['reviewid']."\">"._EDIT."</a>]";
